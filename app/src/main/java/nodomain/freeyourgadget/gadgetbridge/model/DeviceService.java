...
public interface DeviceService extends EventHandler {
    ...
    String ACTION_SET_ANC = PREFIX + ".action.set_anc";
    String ACTION_SET_AMBIENT_SOUND = PREFIX + ".action.set_ambient_sound";
    String ACTION_SET_CLEAR_SOUND = PREFIX + ".action.set_clear_sound";
